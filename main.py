...
class Functions:
    def test_device(self, source):
        ...
        if capture is None or not capture.isOpened():
            raise Exception("Warning: Your device can't open the Camera, please check it.")
    ...
    def start_capturing(self):
        ...
        try:
            ...
            while True:
                ...
                faces = face_cascade.detectMultiScale(gray_scale, scaleFactor=1.3, minSize=(30, 30), minNeighbors=5)
